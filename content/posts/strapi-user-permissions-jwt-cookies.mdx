...
>*Uhhhh, I don't think so?? This is how I responded to this question when Wes Bos asked me the same question.*

>*"You may have to change the 'credentials' value to 'include' in the GQL Playground for it to play properly, link to docs here: https://github.com/graphql/graphql-playground#Settings "*
