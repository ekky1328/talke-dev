...
So if you want to read, and set cookeis using Cloudflare Workers, here is what I did to get it working.

I don't really have the time to explain how this works right now, but here is a code example:
